...
class Item(Resource):
	...
	@jwt_required() # this means that we need to authenticate before running this func
	def get(self, name):
	...
	def post(self, name):
		...
		item = ItemModel(name, **data) # data['price'], data['store_id'] can be simplified by **data
